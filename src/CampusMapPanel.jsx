...
export default function CampusMapPanel({ C, uiLang, onClose }) {
  ...
  return (
    <div style={{ position:"fixed", inset:0, background:"rgba(0,0,0,0.72)", zIndex:2000,
      ...
      <div className="campus-modal" style={{ background:C.surface, borderRadius:22, width:"min(980px,97vw)",
        ...
        {/* Body */}
        <div className="campus-body" style={{ flex:1, overflow:"hidden", display:"flex", minHeight:0 }}>

          {/* Map */}
          <div className="campus-map-col" style={{ flex:"0 0 auto", overflowY:"auto", padding:12, background:C.bg }}>
            <div className="campus-map-inner" style={{ position:"relative", display:"inline-block", width:"min(560px,57vw)" }}>
      ...
      <style>{`
        ...
        @media(max-width:767px){
          ...
          .campus-body{flex-direction:column!important;overflow-y:auto!important;}
          .campus-map-col{flex:none!important;width:100%!important;overflow-y:visible!important;}
          .campus-map-inner{width:100%!important;}
        }
      `}</style>
    </div>
  );
